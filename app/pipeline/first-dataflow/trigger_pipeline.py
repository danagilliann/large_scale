...
def get_duplicates_output():
    os.system('gsutil cp gs://duplicates/outputs/* duplicates-output/') # TODO: Maybe uncomment
...
def put_duplicate_answers_in_db():
    connection = mysql.connector.connect(user='root', passwd='', host='127.0.0.1', db='scalica')
    cursor = connection.cursor()
    query = 'UPDATE micro_question SET duplicate_of = {original_id} WHERE id = {duplicate_id};'
...
def main():
    # get_database_inputs() # TODO: Uncomment
    # put_database_input_to_bucket() # TODO: Uncomment
    # run_duplicates_job() # TODO: Uncomment
    # get_duplicates_output() # TODO: Uncomment
    put_duplicate_answers_in_db() # TODO: Uncomment
